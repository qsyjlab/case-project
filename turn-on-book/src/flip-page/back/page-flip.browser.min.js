// console.log(
//   "��ǰ�����Ϊ��ʾ��,���ܶ��ο�����Դ��ֻ������: http://www.bootstrapmb.com/item/9494 "
// );
// if (location.href.indexOf("ile:") < 0) {
//   if (location.href.indexOf("oo") < 0) {
//     location.href = "http://www.bootstrapmb.com/item/9494";
//   }
// }
/**
...
!(function (t, e) {
  ...
  class h {
    ...
    static GetIntersectByTwoLine(t, e) {
      ...
      if (Math.abs(o - l) < 0.1) throw new Error("Segment included");
      return null;
    }
    ...
    drawSoft(t) {
      ...
      for (const t of this.state.area)
        if (null !== t) {
          ...
          (i = h.GetRotatedPoint(i, { x: 0, y: 0 }, this.state.angle)),
            (e += i.x + "px " + i.y + "px, ");
        }
      (e = e.slice(0, -2)),
        (e += ")"),
  ...
  class o {
    ...
    calculateIntersectPoint(t) {
      ...
      "top" === this.corner
        ? ((this.topIntersectPoint = h.GetIntersectByTwoSegment(
            e,
          ...
          (this.sideIntersectPoint = h.GetIntersectByTwoSegment(
            e,
          ...
          (this.bottomIntersectPoint = h.GetIntersectByTwoSegment(
            e,
  ...
  class w extends g {
    ...
    drawHardInnerShadow() {
      ...
      i > t.pageWidth && (i = t.pageWidth),
        ...
        (this.hardInnerShadow.style.background =
    ...
    drawHardOuterShadow() {
      ...
      e > t.pageWidth && (e = t.pageWidth),
        ...
        (this.hardShadow.style.background =
  ...
  (t.PageFlip = class extends (
    ...
    userMove(t, e) {
      this.isUserTouch || e
        ? this.isUserTouch &&
          h.GetDestinationFromTwoPoint(this.mousePosition, t) > 5 &&
